...
[travis-badge]: https://travis-ci.org/filipesilva/angular-biv-auth-module.svg?branch=master
[travis-badge-url]: https://travis-ci.org/filipesilva/angular-biv-auth-module
...
1. Create a project folder (you can call it `biv-auth-module` and rename it later).
...
```
git clone https://github.com/filipesilva/angular-biv-auth-module.git
cd angular-biv-auth-module
npm install
npm start
```
...
### Download
[Download the QuickStart Library seed](https://github.com/filipesilva/angular-biv-auth-module/archive/master.zip)
...
<table width="100%">
  ...
  <tr>
    <td>
      <code>lib/src/service/auth.service.ts</code>
    </td>
    <td>
...
Use your editor to search the project for all instances of `biv-auth-module` and change it
